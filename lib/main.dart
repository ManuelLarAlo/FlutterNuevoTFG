...
import 'screens/splash_screen.dart'; // Asegúrate de que la ruta es correcta
import 'screens/home_screen.dart';
import 'screens/welcome_screen.dart';
// Asegúrate de que AuthWrapper esté importado correctamente
...
class ClanBarberApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const SplashScreen(),  // La primera pantalla que se muestra es la SplashScreen
      routes: appRoutes
    );
  }
}
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const Scaffold(
            body: Center(child: CircularProgressIndicator()),  // Mientras esperamos, mostramos un indicador de carga
          );
        }
